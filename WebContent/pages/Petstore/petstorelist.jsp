...
<body>
   <table style="width:70%;margin:10px auto;" class="table table-bordered table-condensed table-hover table-responsive table-striped ">
       <caption class="text-center">宠物商店列表</caption>
       <tr>
          <th>id</th>
          <th>name</th>
          <th>password</th>
      ...
      <tr>
       ...
       <%
           ...
           List<PetStore> lists=store_biz.getAll();
           
           Iterator<PetStore> it=lists.iterator();
           
           while(it.hasNext()){
        	   PetStore pet=it.next(); 
       %> 
